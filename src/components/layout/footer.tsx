...
export function Footer() {
  return (
    <footer className="w-full border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-dark-100">
...
function SocialIcon({ platform, className }: { platform: string; className?: string }) {
  // You can replace these paths with actual SVG paths or use a library like react-icons
